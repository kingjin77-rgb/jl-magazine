...
ICONS = {
    ...
    'defect-firedoor':   [p('M8 6h20v36H8z'), p('M23 24h2'),
                          p('M37 14c0 5-6 6-6 12a6 6 0 0 0 12 0c0-4-2-7-6-12z', True),
                          p('M37 27c0 2-2 2-2 4a2 2 0 0 0 4 0c0-1-1-2-2-4', True)],
    'defect-crack':      [p('M8 8h26v32H8z'), p('M19 8l4 10-5 8 6 8-3 6', True),
                          p('M38 14v20'), p('M36 18h4M36 24h4M36 30h4')],
    ...
    'idea-agree':        [p('M6 10h22v15H16l-6 5v-5H6z'), p('M12 16h10'),
                          p('M20 23h22v15h-6l-6 5v-5h-10z', True)],
